package com.rokan.dzikirku.model
...
object DataDzikirku {
    ...
    val listQauliyah: ArrayList<DzikirkuModel>
        get() {
            val list = arrayListOf<DzikirkuModel>()
            for (position in descQauliyah.indices) {
                val qauliyah = DzikirkuModel(
    ...
    val listDzikir: ArrayList<DzikirkuModel>
        get() {
            val list = arrayListOf<DzikirkuModel>()
            for (data in descDzikir.indices) {
                val dzikir = DzikirkuModel(
                    descDzikir[data],
                    lafazDzikir[data],
                    terjemahDzikir[data]
                )
    ...
    val listDzikirPagi: ArrayList<DzikirkuModel>
        get() {
            val list = arrayListOf<DzikirkuModel>()
    ...
    val listDzikirPetang: ArrayList<DzikirkuModel>
        get() {
            val list = arrayListOf<DzikirkuModel>()
